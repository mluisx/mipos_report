...
public class Ventanas2 extends JFrame {
	...
	public static Ventanas2 Ventanas;
	...
	public Ventanas2() {
		...
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
		gbc.insets.left = 25; gbc.insets.top = 25; gbc.insets.right = 25;
		...
		statusPanel.setLayout(new GridBagLayout());
			...
			gbc.insets.left = 15; gbc.insets.top = 5; gbc.insets.right = 15;
		...
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
		gbc.insets.left = 10; gbc.insets.top = 5;
