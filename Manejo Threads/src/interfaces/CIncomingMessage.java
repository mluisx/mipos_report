...
public class CIncomingMessage extends CMessage
{
	...
	*/
	...
	{
//		Maurix
		super(TYPE_INCOMING, date, originator, null, text, memIndex, 0);
	}

	protected CIncomingMessage(String pdu, int memIndex, int sid)
//      Maurix
	{
		super(TYPE_INCOMING, null, null, null, null, memIndex, sid);
	...
	/**
		...
		@param	originator	the originator's phone number (international format).
	*/
