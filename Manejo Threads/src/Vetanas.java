...
public class Vetanas extends JFrame {
	...
	public Vetanas() {
		...
		//mobile = new CUserThread(jSmsServer, this, settings);
		...
		txtManuf = new JTextField("Pruebita 1",16);
		txtManuf.setEditable(true);
		gbc.gridx = 0;
		gbc.gridy = 0;
...
/*
		...
		gbc.gridx=0;
		gbc.gridy=0;
		final JProgressBar Barra; //defino variable Barra
		...
		//Agregamos un boton
		JButton boton = new JButton("A ver que pasa si aprieto");
		//Container bicho = getContentPane();
...
/*
	...
	gbc.gridx = 0;
		...
		public CMainThread getMobile() { return mobile; }
